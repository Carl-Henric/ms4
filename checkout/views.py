...
def cache_checkout_data(request):
    try:
        ...
        return HttpResponse(status=200)
            ...
            messages.error(request, 'Oh, Sorry. Your payment can´t be processed at the moment. \
...
def checkout(request):
            ...
            for item_id, item_data in bag.items():
                try:
                    ...
                    messages.error(request, (
                        "One of the watches in our bag wasn´t find at our storage, please call us for further help")
                    )
                    order.delete()
    ...
    if not stripe_public_key:
        messages.warning(request, 'Stripe public key is missing, check your enviroment')
